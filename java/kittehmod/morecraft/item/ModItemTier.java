...
public class ModItemTier implements IItemTier {
    ...
    public static ModItemTier WITHERBONE = new ModItemTier(3, 6248, 12.0F, 4, 22, Ingredient.fromItems(ModItems.WITHER_BONE.get()));
    public static ModItemTier OBSIDIAN = new ModItemTier(3, 16, 14.0F, 4, 15, Ingredient.fromItems(Blocks.OBSIDIAN));
    public static ModItemTier EMERALD = new ModItemTier(3, 768, 8.0F, 3.0F, 10, Ingredient.fromItems(Items.EMERALD));
    public static ModItemTier RUBY = new ModItemTier(2, 500, 6.0F, 2, 21, Ingredient.fromItems(ModItems.RUBY.get()));
    ...
    public static ModItemTier BEDROCK = new ModItemTier(3, -1, 20.0F, 5, 30, Ingredient.fromItems(Blocks.BEDROCK));
