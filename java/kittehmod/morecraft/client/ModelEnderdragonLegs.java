...
public class ModelEnderdragonLegs extends ModelBiped
{
	...
	public ModelEnderdragonLegs(float expand)
	{
		...
		setRotationAngles(leftlegplate1, 0.7853982F, 0F, -0.0872665F);
		...
		setRotationAngles(leftlegplate2, 0.7853982F, 0F, -0.0872665F);
		...
		setRotationAngles(leftlegplate3, 0.7853982F, 0F, -0.0872665F);
		...
		setRotationAngles(rightlegplate1, 0.7853982F, 0F, 0.0872665F);
		...
		setRotationAngles(rightlegplate2, 0.7853982F, 0F, 0.0872665F);
		...
		setRotationAngles(rightlegplate3, 0.7853982F, 0F, 0.0872665F);
		...
		setRotationAngles(loincloth, -0.0523599F, 0F, 0F);
		...
		setRotationAngles(tailbase, -0.8726646F, 0F, 0F);
		...
		setRotationAngles(tailspike1, 0F, 0F, 0F);
		...
		setRotationAngles(tailspike2, 0F, 0F, 0F);
		...
		setRotationAngles(tailspike3, 0F, 0F, 0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		setRotationAngles(loincloth, this.isSneak ? -0.5F : -0.0523599F, 0F, 0F);
