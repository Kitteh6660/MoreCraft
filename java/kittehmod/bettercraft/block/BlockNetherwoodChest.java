...
public class BlockNetherwoodChest extends BlockChest 
{
	...
	{
		Object object = (TileEntityNetherwoodChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
		if (object == null)
		{
			return null;
		}
		...
		else
		{
			...
			{
				object = new InventoryLargeChest("Large Chest", (TileEntityNetherwoodChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
			}
			if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
			{
				object = new InventoryLargeChest("Large Chest", (IInventory)object, (TileEntityNetherwoodChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
			}
			if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
			{
				object = new InventoryLargeChest("Large Chest", (TileEntityNetherwoodChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
			}
			if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
			{
				object = new InventoryLargeChest("Large Chest", (IInventory)object, (TileEntityNetherwoodChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
			}
