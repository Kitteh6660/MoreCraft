...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> NETHERWOOD_CHEST_TRAPPED = BLOCKS.register("netherwood_trapped_chest", () -> new NetherwoodTrappedChestBlock(Block.Properties.create(Material.WOOD).hardnessAndResistance(2.5F, 6.0F).sound(SoundType.WOOD), () -> { return ModTileEntityType.NETHERWOOD_TRAPPED_CHEST.get(); }));
    ...
    public static final RegistryObject<Block> NETHERWOOD_BOOKSHELF = BLOCKS.register("netherwood_bookshelf", () -> new ModBookshelfBlock(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.5F).sound(SoundType.WOOD)));
    ...
    //Others
    public static final RegistryObject<Block> SOUL_GLASS = BLOCKS.register("soul_glass", () -> new SoulGlassBlock(Block.Properties.create(Material.GLASS).hardnessAndResistance(0.5F, 3.0F).sound(SoundType.GLASS).notSolid()));
	...
	public static final RegistryObject<Block> GLOWSTONE_LANTERN = BLOCKS.register("glowstone_lantern", () -> new GlowstoneLanternBlock(Block.Properties.create(Material.IRON).harvestTool(ToolType.PICKAXE).hardnessAndResistance(3.5F).sound(SoundType.LANTERN).lightValue(15).notSolid()));    
