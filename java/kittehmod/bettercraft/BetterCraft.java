...
@Mod(name = "MoreCraft", modid = BetterCraft.MODID, version = BetterCraft.VERSION, guiFactory = "kittehmod.bettercraft.ConfigurationGuiFactory")
public class BetterCraft 
{
	...
	//--LIST OF BLOCKS--\\
    //Doors & Gates
    public static Block doorNether = new BlockMoreDoors(Material.rock).setHardness(5.0F).setResistance(20.0F).setStepSound(Block.soundTypeStone).setBlockTextureName("doorNether");
    public static Block doorGlass = new BlockMoreDoors(Material.glass).setHardness(1.0F).setResistance(3.0F).setStepSound(Block.soundTypeGlass).setBlockTextureName("doorGlass");
    public static Block doorNetherwood = new BlockMoreDoors(Material.wood).setHardness(2.5F).setResistance(7.5F).setStepSound(Block.soundTypeWood).setBlockTextureName("doorNetherwood");
    public static Block doorBone = new BlockMoreDoors(Material.rock).setHardness(2.5F).setResistance(7.5F).setStepSound(Block.soundTypeWood).setBlockTextureName("doorBone");
    public static Block gateNetherBrick = new BlockNetherBrickFenceGate().setHardness(2.0F).setResistance(20.0F).setStepSound(Block.soundTypeStone).setBlockTextureName("gateNetherBrick");
    
    //Ores
    public static final Block RubyOre = new BlockOreRuby(Material.rock).setHardness(4.0F).setResistance(2.0F).setStepSound(Block.soundTypeStone).setBlockName("oreRuby").setBlockTextureName("bettercraft:RubyOre");
   
    //Storage Blocks
    public static final Block BoneBlock = new BlockStorage(Material.rock).setHardness(3.0F).setResistance(8.0F).setStepSound(Block.soundTypeStone).setBlockName("blockBone").setBlockTextureName("bettercraft:BoneBlock");
    public static final Block FleshBlock = new BlockStorage(Material.cloth).setHardness(1.0F).setResistance(2.0F).setStepSound(Block.soundTypeCloth).setBlockName("blockFlesh").setBlockTextureName("bettercraft:FleshBlock");
    public static final Block RubyBlock = new BlockStorage(Material.rock).setHardness(6.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setBlockName("blockRuby").setBlockTextureName("bettercraft:RubyBlock");
    public static final Block BlazeBlock = new BlockBlazeBlock().setHardness(10.0F).setResistance(15.0F).setStepSound(Block.soundTypeMetal).setLightLevel(1.0F).setBlockName("blockBlaze").setBlockTextureName("bettercraft:BlazeBlock");
    public static final Block EnderBlock = new BlockStorage(Material.rock).setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("blockEnder").setBlockTextureName("bettercraft:EnderBlock");    
    public static final Block GunpowderBlock = new BlockGunpowder().setHardness(0.5F).setResistance(5.0F).setStepSound(Block.soundTypeStone).setBlockName("blockGunpowder").setBlockTextureName("bettercraft:GunpowderBlock");    
    public static final Block SlimeBlock = new BlockSlimeBlock(Material.sand).setHardness(0.5F).setResistance(5.0F).setStepSound(Block.soundTypeSand).setBlockName("blockSlime").setBlockTextureName("bettercraft:SlimeBlock"); //Will be removed in 1.8.
    public static final Block BedrockBrick = new BlockNormal(Material.rock).setBlockUnbreakable().setResistance(5.0F).setStepSound(Block.soundTypeStone).setBlockName("bedrockBrick").setBlockTextureName("bettercraft:BedrockBrick");    
    
    //Netherwood
    public static final Block NetherLog = new BlockNetherLog().setHardness(3.0F).setResistance(8.0F).setStepSound(Block.soundTypeWood).setBlockName("netherLog").setBlockTextureName("bettercraft:Netherwood");
    public static final Block NetherPlanks = new BlockNetherWood().setHardness(3.0F).setResistance(8.0F).setStepSound(Block.soundTypeWood).setBlockName("netherPlanks").setBlockTextureName("bettercraft:NetherPlanks");
    ...
    //Ender Bricks
    public static final Block EndBrickBlock = new BlockNormal(Material.rock).setHardness(10.0F).setResistance(15.0F).setStepSound(Block.soundTypeStone).setBlockName("enderBrick").setBlockTextureName("bettercraft:EndBrickBlock");
    public static final Block EndBrickStair = new BlockNormalStairs(EndBrickBlock, 0).setHardness(10.0F).setResistance(15.0F).setStepSound(Block.soundTypeStone).setBlockName("stairsEnderBrick").setBlockTextureName("bettercraft:EndBrickBlock");
    public static final Block EndBrickSlab = new BlockNormalSlab(false, Material.rock).setHardness(10.0F).setResistance(15.0F).setStepSound(Block.soundTypeStone).setBlockName("slabEnderBrick").setBlockTextureName("bettercraft:EndBrickBlock");
    public static final Block EndBrickSlabFull = new BlockNormalSlab(true, Material.rock).setHardness(10.0F).setResistance(15.0F).setStepSound(Block.soundTypeStone).setBlockName("slabEnderBrick").setBlockTextureName("bettercraft:EndBrickBlock");
    
    //Others
    public static final Block StoneStair = new BlockNormalStairs(Blocks.stone, 0).setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("stairStone").setBlockTextureName("bettercraft:StoneStair");
    public static final Block IronTrapdoor = new BlockIronTrapdoor(Material.iron).setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setCreativeTab(CreativeTabs.tabRedstone).setBlockName("trapdoorIron").setBlockTextureName("bettercraft:trapdoorIron"); //Will be removed in 1.8.
    public static final Block SoulGlass = new BlockSoulGlass(Material.glass, false).setHardness(0.5F).setResistance(15.0F).setStepSound(Block.soundTypeGlass).setBlockName("soulGlass").setBlockTextureName("bettercraft:SoulGlass");
    public static final Block BoneLadder = new BlockBoneLadder().setHardness(1.5F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("boneLadder").setCreativeTab(CreativeTabs.tabDecorations).setBlockTextureName("bettercraft:BoneLadder");
    public static final Block GlowstoneTorch = (new BlockGlowstoneTorch()).setBlockName("glowstoneTorch").setCreativeTab(CreativeTabs.tabDecorations).setBlockTextureName("bettercraft:GlowstoneTorch");
    ...
    public static Item NetherBrickDoor = (new ItemMoreDoors(doorNether)).setUnlocalizedName("doorNether").setCreativeTab(CreativeTabs.tabRedstone).setTextureName("bettercraft:doorNether");
    public static Item GlassDoor = (new ItemMoreDoors(doorGlass)).setUnlocalizedName("doorGlass").setCreativeTab(CreativeTabs.tabRedstone).setTextureName("bettercraft:doorGlass");
    public static Item NetherwoodDoor = (new ItemMoreDoors(doorNetherwood)).setUnlocalizedName("doorNetherwood").setCreativeTab(CreativeTabs.tabRedstone).setTextureName("bettercraft:doorNetherwood");
    public static Item BoneDoor = (new ItemMoreDoors(doorBone)).setUnlocalizedName("doorBone").setCreativeTab(CreativeTabs.tabRedstone).setTextureName("bettercraft:doorBone");
    ...
    public static final Item swordWitherbone = new ItemNormalSword(WITHERBONE_T, witherBone).setUnlocalizedName("swordWitherbone").setTextureName("bettercraft:witherbone_sword");
    ...
    public static final Item swordBlaze = new ItemNormalSword(BLAZE_T, Items.blaze_rod).setUnlocalizedName("swordBlaze").setTextureName("bettercraft:blaze_sword");
