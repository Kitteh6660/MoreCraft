...
public class ModBlocks {
	...
	public static final RegistryObject<Block> NETHERITE_DOOR = BLOCKS.register("netherite_door", () -> new ModDoorBlock(AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(50.0F, 1200.0F).sound(SoundType.METAL).notSolid().func_235861_h_().harvestTool(ToolType.PICKAXE).harvestLevel(3)));
    ...
    public static final RegistryObject<Block> NETHERITE_TRAPDOOR = BLOCKS.register("netherite_trapdoor", () -> new ModTrapDoorBlock(AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(50.0F, 1200.0F).sound(SoundType.METAL).notSolid().func_235861_h_().harvestTool(ToolType.PICKAXE).harvestLevel(3)));

    //Ores
    public static final RegistryObject<Block> RUBY_ORE = BLOCKS.register("ruby_ore", () -> new ModOreBlock(AbstractBlock.Properties.create(Material.ROCK).func_235861_h_().harvestTool(ToolType.PICKAXE).func_235861_h_().harvestLevel(2).hardnessAndResistance(3.0F, 3.0F)));
    ...
    public static final RegistryObject<Block> RUBY_BLOCK = BLOCKS.register("ruby_block", () -> new Block(AbstractBlock.Properties.create(Material.ROCK).func_235861_h_().harvestTool(ToolType.PICKAXE).harvestLevel(2).hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final RegistryObject<Block> BLAZE_BLOCK = BLOCKS.register("blaze_block", () -> new BlazeBlock(AbstractBlock.Properties.create(Material.IRON).func_235861_h_().harvestTool(ToolType.PICKAXE).harvestLevel(1).hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL).func_235838_a_((p_235464_0_) -> { return 15; })));
    public static final RegistryObject<Block> ENDER_BLOCK = BLOCKS.register("ender_block", () -> new Block(AbstractBlock.Properties.create(Material.ROCK).func_235861_h_().harvestTool(ToolType.PICKAXE).harvestLevel(1).hardnessAndResistance(2.5F, 6.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> NETHERWOOD_LEAVES = BLOCKS.register("netherwood_leaves", () -> new NetherwoodLeavesBlock(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F, 1.0F).notSolid()));
    ...
    public static final RegistryObject<Block> NETHERWOOD_CRAFTING_TABLE = BLOCKS.register("netherwood_crafting_table", () -> new NetherwoodCraftingTableBlock(AbstractBlock.Properties.create(Material.WOOD).hardnessAndResistance(3.0F, 4.0F).sound(SoundType.WOOD)));
