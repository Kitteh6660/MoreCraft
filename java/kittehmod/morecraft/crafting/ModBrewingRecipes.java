...
{	
	...
	public static void registerRecipes() {
		...
		BrewingRecipeRegistry.addRecipe(new ModBrewingRecipe(PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.HEALTH_BOOST.get()), new ItemStack(Items.GLOWSTONE), PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.STRONG_HEALTH_BOOST.get())));
	}
