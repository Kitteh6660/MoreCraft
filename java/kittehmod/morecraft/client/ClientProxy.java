...
import kittehmod.morecraft.CommonProxy;
...
public class ClientProxy extends CommonProxy
{
	...
	public void registerRenderersPreInit()
	{
		RenderingRegistry.registerEntityRenderingHandler(EntityNetherwoodBoat.class, new IRenderFactory() {
			@Override public Render<? super EntityNetherwoodBoat> createRenderFor(RenderManager manager) { return new EntityNetherwoodBoatRenderer(manager); }	
		});
	}
