...
public class ModItems {
	...
	public static final RegistryObject<Item> NETHERWOOD_CRAFTING_TABLE = ITEMS.register("netherwood_crafting_table", () -> new ModCraftingTableItem(ModBlocks.NETHERWOOD_CRAFTING_TABLE.get(), new Item.Properties().tab(conditionallyAddTab("variant_crafting_tables", ItemGroup.TAB_DECORATIONS))));
    public static final RegistryObject<Item> NETHERWOOD_CRAFTING_TABLE_MINECART = ITEMS.register("netherwood_crafting_table_minecart", () -> new CraftingTableMinecartItem(new Item.Properties().tab(conditionallyAddTab("variant_crafting_tables", ItemGroup.TAB_TRANSPORTATION)).stacksTo(1), CraftingTableMinecartEntity.CraftingTableType.NETHERWOOD));
