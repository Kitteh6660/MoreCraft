...
public class CrateScreen extends ContainerScreen<ModCrateContainer>
{
	...
	public CrateScreen(ModCrateContainer p_i51078_1_, PlayerInventory p_i51078_2_, ITextComponent p_i51078_3_) {
	...
	protected void renderBg(MatrixStack matrix, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		...
		this.blit(matrix, i, j + containerRows * 18 + 17, 0, 126, this.imageWidth, 96);
	}
}
