...
public class ModChestBlock extends AbstractChestBlock<NetherwoodChestTileEntity> implements IWaterLoggable
{
	...
	private static final TileEntityMerger.ICallback<NetherwoodChestTileEntity, Optional<IInventory>> CHEST_COMBINER = new TileEntityMerger.ICallback<NetherwoodChestTileEntity, Optional<IInventory>>() {

		public Optional<IInventory> acceptDouble(NetherwoodChestTileEntity p_225539_1_, NetherwoodChestTileEntity p_225539_2_) {
			return Optional.of(new DoubleSidedInventory(p_225539_1_, p_225539_2_));
		}

		public Optional<IInventory> acceptSingle(NetherwoodChestTileEntity p_225538_1_) {
	...
	private static final TileEntityMerger.ICallback<NetherwoodChestTileEntity, Optional<INamedContainerProvider>> MENU_PROVIDER_COMBINER = new TileEntityMerger.ICallback<NetherwoodChestTileEntity, Optional<INamedContainerProvider>>() {
		public Optional<INamedContainerProvider> acceptDouble(final NetherwoodChestTileEntity p_225539_1_, final NetherwoodChestTileEntity p_225539_2_) {
		...
		public Optional<INamedContainerProvider> acceptSingle(NetherwoodChestTileEntity p_225538_1_) {
			return Optional.of(p_225538_1_);
		}
	...
	protected ModChestBlock(AbstractBlock.Properties builder, Supplier<TileEntityType<? extends NetherwoodChestTileEntity>> blockEntityTypeIn) {
	...
	@Nullable
	public static IInventory getChestInventory(ModChestBlock chest, BlockState state, World world, BlockPos pos, boolean override) {
		return chest.combine(state, world, pos, override).apply(CHEST_COMBINER).orElse((IInventory) null);
	}

	@Override
	public TileEntityMerger.ICallbackWrapper<? extends NetherwoodChestTileEntity> combine(BlockState state, World world, BlockPos pos, boolean override) {
	...
	@OnlyIn(Dist.CLIENT)
	public static TileEntityMerger.ICallback<NetherwoodChestTileEntity, Float2FloatFunction> opennessCombiner(final IChestLid lid) {
		return new TileEntityMerger.ICallback<NetherwoodChestTileEntity, Float2FloatFunction>() {
			public Float2FloatFunction acceptDouble(NetherwoodChestTileEntity p_225539_1_, NetherwoodChestTileEntity p_225539_2_) {
				return (p_226921_2_) -> { return Math.max(p_225539_1_.getOpenNess(p_226921_2_), p_225539_2_.getOpenNess(p_226921_2_)); };
			}

			public Float2FloatFunction acceptSingle(NetherwoodChestTileEntity p_225538_1_) {
	...
	public TileEntityType<? extends NetherwoodChestTileEntity> getTileEntityType() {
