...
public class ModVerticalSlabBlock extends Block implements IWaterLoggable
{
	...
	public ModVerticalSlabBlock(Properties properties) {
		super(properties);
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		BlockState retState = defaultBlockState().setValue(WATERLOGGED, fluid.getFluidState().getType() == Fluids.WATER);
	...
	public boolean canBeReplaced(BlockState state, BlockItemUseContext useContext) {
		...
		return slabtype != VerticalSlabType.DOUBLE && itemstack.getItem() == asItem() && useContext.replacingClickedOnBlock() && (useContext.getClickedFace() == direction && getDirectionForPlacement(useContext) == direction);
	}
