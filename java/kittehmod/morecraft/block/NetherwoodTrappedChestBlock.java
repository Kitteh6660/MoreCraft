...
public class NetherwoodTrappedChestBlock extends AbstractChestBlock<NetherwoodTrappedChestTileEntity> implements IWaterLoggable {
	...
	public static TileEntityMerger.Type func_226919_h_(BlockState p_226919_0_) {
	   ...
	   @Nullable
	   public static IInventory func_226916_a_(NetherwoodTrappedChestBlock p_226916_0_, BlockState p_226916_1_, World p_226916_2_, BlockPos p_226916_3_, boolean p_226916_4_) {
	   ...
	   @Override
	   public TileEntityMerger.ICallbackWrapper<? extends NetherwoodTrappedChestTileEntity> func_225536_a_(BlockState p_225536_1_, World p_225536_2_, BlockPos p_225536_3_, boolean p_225536_4_) {
	      ...
	      return TileEntityMerger.func_226924_a_(this.tileEntityType.get(), NetherwoodTrappedChestBlock::func_226919_h_, NetherwoodTrappedChestBlock::getDirectionToAttached, FACING, p_225536_1_, p_225536_2_, p_225536_3_, bipredicate);
	   }
	   ...
	   @OnlyIn(Dist.CLIENT)
	   public static TileEntityMerger.ICallback<NetherwoodTrappedChestTileEntity, Float2FloatFunction> func_226917_a_(final IChestLid p_226917_0_) {
	      return new TileEntityMerger.ICallback<NetherwoodTrappedChestTileEntity, Float2FloatFunction>() {
	         public Float2FloatFunction func_225539_a_(NetherwoodTrappedChestTileEntity p_225539_1_, NetherwoodTrappedChestTileEntity p_225539_2_) {
	            return (p_226921_2_) -> {
	               return Math.max(p_225539_1_.getLidAngle(p_226921_2_), p_225539_2_.getLidAngle(p_226921_2_));
	            };
	         }

	         public Float2FloatFunction func_225538_a_(NetherwoodTrappedChestTileEntity p_225538_1_) {
