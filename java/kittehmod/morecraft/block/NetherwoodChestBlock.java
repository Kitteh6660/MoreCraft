...
public class NetherwoodChestBlock extends AbstractChestBlock<NetherwoodChestTileEntity> implements IWaterLoggable
{
	...
	public static TileEntityMerger.Type getChestMergerType(BlockState blockStateIn) {
		ChestType chesttype = blockStateIn.get(TYPE);
	...
	@Nullable
	public static IInventory getChestInventory(NetherwoodChestBlock chest, BlockState state, World world, BlockPos pos, boolean override) {
		return chest.combine(state, world, pos, override).apply(field_220109_i).orElse((IInventory) null);
	}
	...
	public TileEntityMerger.ICallbackWrapper<? extends NetherwoodChestTileEntity> combine(BlockState state, World world, BlockPos pos, boolean override) {
		...
		return TileEntityMerger.func_226924_a_(this.tileEntityType.get(), NetherwoodChestBlock::getChestMergerType, NetherwoodChestBlock::getDirectionToAttached, FACING, state, world, pos, bipredicate);
	}
	...
	@OnlyIn(Dist.CLIENT)
	public static TileEntityMerger.ICallback<NetherwoodChestTileEntity, Float2FloatFunction> getLidRotationCallback(final IChestLid lid) {
		return new TileEntityMerger.ICallback<NetherwoodChestTileEntity, Float2FloatFunction>() {
			public Float2FloatFunction func_225539_a_(NetherwoodChestTileEntity p_225539_1_, NetherwoodChestTileEntity p_225539_2_) {
				return (p_226921_2_) -> { return Math.max(p_225539_1_.getLidAngle(p_226921_2_), p_225539_2_.getLidAngle(p_226921_2_)); };
			}
	...
	private static boolean isCatSittingOn(IWorld p_220107_0_, BlockPos p_220107_1_) {
		List<CatEntity> list = p_220107_0_.getEntitiesWithinAABB(CatEntity.class, new AxisAlignedBB((double) p_220107_1_.getX(), (double) (p_220107_1_.getY() + 1), (double) p_220107_1_
