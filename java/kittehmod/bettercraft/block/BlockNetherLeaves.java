...
public class BlockNetherLeaves extends BlockLeavesBase
{
	...
	{
		if (par1World.isRaining() && !par1World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4) && par1World.canBlockSeeTheSky(par2, par3, par4) && par5Random.nextInt(15) == 1)
		{
