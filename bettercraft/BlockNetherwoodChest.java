...
public class BlockNetherwoodChest extends BlockContainer
{
    private final Random random = new Random();

    /** At the moment, there is only one chest type and that's netherwood which is 0. */
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityNetherwoodChest TileEntityNetherwoodChest = (TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (TileEntityNetherwoodChest != null)
        {
            for (int j1 = 0; j1 < TileEntityNetherwoodChest.getSizeInventory(); ++j1)
            {
                ItemStack itemstack = TileEntityNetherwoodChest.getStackInSlot(j1);
    ...
    {
        Object object = (TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (TileEntityNetherwoodChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityNetherwoodChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("BetterCraft:NetherPlanks");
    }
}
