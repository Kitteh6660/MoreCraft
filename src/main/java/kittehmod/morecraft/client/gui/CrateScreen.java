...
public class CrateScreen extends AbstractContainerScreen<ModCrateContainer>
{
	...
	public CrateScreen(ModCrateContainer p_i51078_1_, Inventory p_i51078_2_, Component p_i51078_3_) {
	...
	public void render(GuiGraphics matrix, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
	...
	protected void renderBg(GuiGraphics matrix, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
		...
		matrix.blit(CONTAINER_TEXTURE, i, j, 0, 0, this.imageWidth, containerRows * 18 + 17);
		matrix.blit(CONTAINER_TEXTURE, i, j + containerRows * 18 + 17, 0, 126, this.imageWidth, 96);
	}
}
