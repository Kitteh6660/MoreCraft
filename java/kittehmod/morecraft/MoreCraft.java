...
public class MoreCraft 
{
	...
	private void setupClient(final FMLClientSetupEvent event)
    {
    	...
    	RecipeBookRegistry.addCategoriesFinder(ModRecipeType.KILN, rc -> ModRecipeBookCategories.KILN_BLOCKS );
    	RecipeBookRegistry.addCategoriesFinder(ModRecipeType.KILN, rc -> ModRecipeBookCategories.KILN_MISC );
