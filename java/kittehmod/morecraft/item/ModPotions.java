...
public class ModPotions extends Potions 
{
	...
	public static final RegistryObject<Potion> RESISTANCE = POTION_TYPES.register("resistance", () -> new Potion("resistance", new EffectInstance(Effects.DAMAGE_RESISTANCE, 3600)));
	public static final RegistryObject<Potion> LONG_RESISTANCE = POTION_TYPES.register("long_resistance", () -> new Potion("resistance", new EffectInstance(Effects.DAMAGE_RESISTANCE, 9600)));
	public static final RegistryObject<Potion> STRONG_RESISTANCE = POTION_TYPES.register("strong_resistance", () -> new Potion("resistance", new EffectInstance(Effects.DAMAGE_RESISTANCE, 1800, 1)));
