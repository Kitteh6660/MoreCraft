...
public class NetherChestBoat extends NetherBoat implements HasCustomInventoryScreen, ContainerEntity
{
	...
	public NetherChestBoat(EntityType<? extends NetherBoat> p_219869_, Level p_219870_) {
		super(p_219869_, p_219870_);
	}

	public NetherChestBoat(Level p_219872_, double p_219873_, double p_219874_, double p_219875_) {
		this(ModEntities.NETHER_CHEST_BOAT.get(), p_219872_);
